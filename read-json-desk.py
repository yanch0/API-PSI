...
wks = gc.open("SheetsTest").get_worksheet(1)
...
while True:
    ...
    url = str("https://www.googleapis.com/pagespeedonline/v5/runPagespeed?url=https://" + a + "/&strategy=desktop&locale=en&key=AIzaSyCb3u9C1oiKokdEkRtjPOGp_FZVwbVQh4g")
